...
Usuario _$UsuarioFromMap(Map map) => Usuario()
  ...
  ..dataNascimento =
      map['dataNascimento'] != null ? map['dataNascimento'] : initialTime
  ..enderecoLogradouroRua =
      map['enderecoLogradouroRua'] != null ? map['enderecoLogradouroRua'] : ""
  ...
  ..valorPagamento =
      map['valorPagamento'] != null ? map['valorPagamento'] : null
  ..dataPagamento =
      map['dataPagamento'] != null ? map['dataPagamento'] : initialTime
  ...
  ..ultimoPagamentoGerado = map['ultimoPagamentoGerado'] != null
      ...
      : initialTime
  ..preferenciaNome =
      map['preferenciaNome'] != null ? map['preferenciaNome'] : ""
  ...
  ..emailVerificado =
      map['emailVerificado'] != null ? map['emailVerificado'] : false;
